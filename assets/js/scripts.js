...
$(".first-card-btn").click(function() {
  $(this)
    .siblings("div")
    .children("div")
    .toggleClass("hidden-paragraph");

  if ($("#panel").hasClass("firstCard-Paragraph-shape")) {
    $("#panel").removeClass("firstCard-Paragraph-shape");
  } else {
    setTimeout(function() {
      $("#panel").addClass("firstCard-Paragraph-shape");
    }, 200);
  }
  ...
  $(this)
    .siblings("div")
    .toggleClass("selected-card");
});

$(".card-slide-close").click(function() {
  $(this)
    .siblings("div")
    .addClass("hidden-paragraph");
  setTimeout(function() {
    $("#panel").addClass("firstCard-Paragraph-shape");
  }, 200);
  $(this)
...
$(".first-card-btn , .card-slide-close").click(function() {
